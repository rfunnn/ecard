  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-md p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Daftar Akaun</h1>
        <p className="text-sm text-gray-500 mb-6">Cipta akaun baharu anda</p>
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white px-3 text-xs text-gray-400">atau daftar dengan e-mel</span>
          </div>
        </div>

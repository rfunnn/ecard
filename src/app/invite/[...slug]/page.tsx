...
interface Props {
  // catch-all: slugParts[0] = card slug, slugParts[1+] = ignored pretty-path
...
export default async function InvitePage({ params, searchParams }: Props) {
  ...
  if (slug === "demo") {
    ...
    // When an admin previews a template that has been authored, use the full
    // authored config so changes to animation, animation colour, and text colour
    // are reflected immediately — not the hardcoded demo defaults.
    ...
    const demoGiftItems = packageParam === "gold"
      ? [
          ...
          { id: "demo-gift-3", label: "Blender Dapur Elektrik", imageUrl: "https://picsum.photos/seed/kitchenblend/400/400", link: "https://www.lazada.com.my/", sortOrder: 2 },
        ]
      : []

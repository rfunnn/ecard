    ...
    <div className="min-h-screen bg-[var(--pg)]">
      <header className="sticky top-0 z-20 bg-[var(--pg-alt)] border-b border-[var(--bd)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          ...
          <span className="text-xs text-[var(--tx-3)] font-medium uppercase tracking-wide">Partner Dashboard</span>
          <div className="flex items-center gap-3">
            {partner.status === "ACTIVE" && (
              <Link href="/partner/billing" className="text-xs text-[var(--tx-2)] hover:text-[var(--tx-1)] transition-colors">
                Bil & Invois
              </Link>
            )}

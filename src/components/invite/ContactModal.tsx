...
export function ContactModal({ isOpen, onClose, card, onAnalytic, contained }: ContactModalProps) {
  ...
  const iconButtonStyle: React.CSSProperties = { border: `1.5px solid ${primaryColor}40` }
  ...
  return (
    <InviteBottomSheet isOpen={isOpen} onClose={onClose} contained={contained}>
      ...
      >
        <p className="text-center text-xs font-bold tracking-[0.2em] mb-4" style={{ color: primaryColor }}>
          {heading}
        </p>

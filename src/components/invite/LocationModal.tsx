...
export function LocationModal({ isOpen, onClose, card, onAnalytic }: LocationModalProps) {
  ...
  const label = card.language === "ms" ? "LOKASI" : "LOCATION"
        ...
        <>
          ...
          >
            ...
            >
              {/* title */}
              <p
                className="text-center text-xs font-bold tracking-[0.2em] mb-3"
              ...
              {card.venueName && (
                <p
                  className="text-center font-semibold text-sm mb-1 uppercase tracking-wide"
                  style={{ color: primaryColor }}
                >
                  {card.venueName}
                </p>

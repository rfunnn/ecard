...
const WA_NUMBER = "601164981201"
const WA_MESSAGE = "Hello, saya ingin bertanya tentang ekadku.com"
...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-5 z-50 flex items-center gap-2 text-white text-[13px] font-semibold px-4 py-2.5 rounded-full shadow-lg transition-all hover:shadow-xl active:scale-95"
